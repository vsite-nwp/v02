...
//
//	virtual bool OnCommand(int id, WORD childMessage, WPARAM wParam, LPARAM lParam) {
//		
...
//	//	//HWND lb = GetDlgItem(this->Handle, IDC_LB);
//	//	//HWND rem = GetDlgItem(this->Handle, IDC_REMOVE);
//	//	//
//	//	//switch (id) 
//	//	//{
//	//	//case ID_FILE_EXIT:
...
//	//	//	break;
//	//	//case ID_HELP_ABOUT:
//	//	//	MessageBox(this->Handle, (LPCSTR)"this is help", (LPCSTR)"HELP", MB_HELP);
//	//	//	// TODO: show dialog with text
//	//	//	break;
//	//	//case IDC_ADD:
//
//	//	//	GetDlgItemText(this->Handle, IDC_EDIT, (LPSTR)text, 15);
