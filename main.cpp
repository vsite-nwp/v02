...
int MainWindow::OnCreate(CREATESTRUCT* pcs)
{
	...
	Button_Remove.Create(*this, WS_CHILD | WS_VISIBLE, "Remove", IDC_REMOVE, 150 , 130, 120, 30);
...
void MainWindow::OnCommand(int id){
	switch(id){
		...
		case IDC_REMOVE:
			...
			//HWND ListBox = GetDlgItem(*this, IDC_LB);
			//HWND Button_Remove = GetDlgItem(*this, IDC_REMOVE);
			//if (SendDlgItemMessage(ListBox, IDC_LB, LB_ERR, 0, 0) != LB_ERR)
			//{
			//	SendDlgItemMessage(Button_Remove, IDC_REMOVE,)
			//}
